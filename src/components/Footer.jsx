                            ...
                            <div className="col-lg-3">
                                <div className="d-flex justify-content-end pt-3">
                                    <a className="btn me-2" href="">
                                        <TwitterIcon style={{ fontSize: "35px", color: "#ffb524" }} />
                                    </a>
                                    <a className="btn me-2" href="">
                                        <FacebookOutlinedIcon style={{ fontSize: "35px", color: "#ffb524" }} />
                                    </a>
                                    <a className="btn me-2" href="">
                                        <YouTubeIcon style={{ fontSize: "35px", color: "#ffb524" }} />
                                    </a>
                                    <a className="btn me-2" href="">
                                        <LinkedInIcon style={{ fontSize: "35px", color: "#ffb524" }}/>
                                    </a>
                                </div>
                            </div>
                        </div>
